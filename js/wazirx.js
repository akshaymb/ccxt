...
module.exports = class wazirx extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'api': {
                    'v1': 'https://api.wazirx.com/uapi/v1',
                    'v2': 'https://api.wazirx.com/api/v2'
                },
                'www': 'https://wazirx.com/',
                'doc': [
                    'https://wazirx.github.io/',
                ],
    ...
    async fetchStatus (params = {}) {
        const response = await this.v1GetSystemStatus (params);
        // { 
    ...
    async fetchMarkets (params = {}) {
        const response = await this.v2GetMarketStatus (params);
        //
        //     [
        //         {
        //             "id":"BTC",
        ...
        for (let i = 0; i < response.markets.length; i++) {
            ...
            const id = this.safeString (market, 'baseMarket') + this.safeString (market, 'quoteMarket');
            ...
            const bidFee = this.safeValue (fee, 'bid', {});
            const taker = this.safeValue (bidFee, 'taker');
            const maker = this.safeValue (bidFee, 'maker');
            const precision = {
    ...
    async fetchOrderBook (symbol, limit = undefined, params = {}) {
        ...
        const response = await this.v2GetDepth (this.extend (request, params));
        //
        //     {
        //         "bids":[
        //             [49352.04,0.843948],
